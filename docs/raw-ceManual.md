...
> Note: This is an over-simplification, as some portions of jobs that do not need to be waited upon are allowed
  ...
  like this, the *safe* portion of job1 may interleave with any portion of job2 on the queue.
