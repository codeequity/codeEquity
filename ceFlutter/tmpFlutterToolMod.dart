/*
  https://github.com/flutter/flutter/issues/181357#issuecomment-3876481702
   1) musick@maple:~/pop/src/codeEquity/codeEquity/ceFlutter$ flutter clean
   2) update: 
      musick@maple:~/fvm/versions/master/packages/flutter_tools/lib/src/isolated/resident_web_runner.dart
        // late final useDwdsWebSocketConnection = flutterDevice!.device is! ChromiumDevice;
        late final useDwdsWebSocketConnection = true;
     
   3) force rebuild
      rm ~/fvm/versions/master/bin/cache/flutter_tools.snapshot
*/
