...
class Allocation {
   ...
   Allocation({this.category, this.amount, this.allocType, this.ceUID, this.ghUserName, this.vestedPerc, this.notes });

   // Not explicitly constructed in lambda handler - watch caps
   dynamic toJson() => {'Category': category, 'Amount': amount, 'AllocType': enumToStr(allocType),
